...
export default function Footer(){
    ...
    return (
        <footer className="relative  border-t  border-white/[0.2] productFont bg-hero-gradient">
            <div className="absolute top-0 z-[500] h-full w-screen bg-[#08090a] bg-[radial-gradient(ellipse_20%_80%_at_50%_-20%,rgba(120,119,198,0.3),rgba(255,255,255,0))]"></div>
